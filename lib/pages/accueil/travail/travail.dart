...
class _TravailState extends State<Travail> {
  ...
  void initState() {
    super.initState();
    fabrication.add({'id': 1, 'name': 'C0-1'});
    fabrication.add({'id': 2, 'name': 'C0-2'});

    product = [
      {'ID': 1, 'Name': 'C0O-1', 'ParentId': 1},
      {'ID': 2, 'Name': 'C00-2', 'ParentId': 1},
      {'ID': 1, 'Name': 'CAA-1', 'ParentId': 2},
      {'ID': 2, 'Name': 'CAA-2', 'ParentId': 2},
    ];
    operation = [
                        ...
                        child: Column(
                            ...
                            children:  [
                              const Align(
                                ...
                                child: Text("Lista de activități",
                                  style: TextStyle(
                                      fontSize:12,
                                      fontFamily: 'Poppins',
